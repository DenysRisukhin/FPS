...
PowerBall::PowerBall(ISceneManager* manager, IVideoDriver* driver, vector3df start, vector3df end, f32 ballSpeed) : GameObject(start, ballSpeed, manager), direction(0)
{
